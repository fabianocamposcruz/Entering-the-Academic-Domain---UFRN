...
if (1 -eq 0) { #($dominio -eq "ad.ufrn.br") {
	[System.Windows.Forms.MessageBox]::Show("O COMPUTADOR JA ESTA NO DOMINIO '$dominio'. NENHUMA ALTERACAO E NECESSARIA.", "INFORMACAO", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
    exit
}
else {
	if (Test-Path -Path "C:\$Env:HOMEPATH\validaufrn.txt") {
		...
		$resposta3 = [System.Windows.Forms.MessageBox]::Show("DESEJA INGRESSAR NO DOMINIO: 'ad.ufrn.br'? SIM, PARA INSERIR CREDENCIAIS. NAO, PARA SAIR.", "CONFIRMACAO", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
		...
		$main_form.Text ='UFRN/CT: INSERIR WINDOWS NO DOMINIO ACADEMICO'
		$main_form.Width = 580
		...
		$LabelDescricao.Text = "Software desenvolvido em PowerShell para ingresso de computadores Windows `nsob gerencia do CT no dominio acadêmico da UFRN: 'ad.ufrn.br'. `nCertifique-se de: 1) Estar logado com perfil de administrador; `n                              2) Este executavel esteja em 'C:\Windows\System32\'."
		...
		$LabelRodape.Text = "©2025 - Desenvolvido por Pitagoras/CT"
		...
		$ComboBoxUnidade.Add_SelectedIndexChanged({
			...
			if ($index -ge 0) {
				...
				$LabelCodigo.Text = "Codigo: $global:codigo_unidade"
			}
		})

		# ----- Localização -----
		$LabelLocal = New-Object System.Windows.Forms.Label
		$LabelLocal.Text = "Localizacao:"
		...
		$GroupBoxIdent.Text = "Identificacao unica:"
		...
		$RadioPatrimonio.Text = "Patrimonio (SIPAC)"
		...
		$GroupBoxAquisicao.Text = "Origem da aquisicao:"
		...
		$RadioAquisicaoUFRN.Text = "Aquisicao da UFRN"
		...
		$ButtonRenomear.Text = "RENOMEAR COMPUTADOR E INSERIR NO DOMINIO"
		...
		$ButtonRenomear.Add_Click({
			...
			if (-not $codigo_unidade -or -not $localCodigoSelecionado -or -not $identificacao -or $aquisicao -or $global:setorCodigoSelecionado -eq $null) {
				[System.Windows.Forms.MessageBox]::Show("POR FAVOR, PREENCHA TODOS OS CAMPOS OBRIGATORIOS.", "ATENCAO", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
				return				
			}
			...
			try {
				...
				if ($current_hostname -eq $new_name) {
					$resposta1 = [System.Windows.Forms.MessageBox]::Show("O NOME DO COMPUTADOR JA E: '$new_name'. NENHUMA ALTERACAO E NECESSARIA. DESEJA INGRESSAR NO DOMINIO? SIM, PARA INSERIR CREDENCIAIS. NAO, PARA SAIR.", "CONFIRMACAO", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
					...
					$resposta2 = [System.Windows.Forms.MessageBox]::Show("O COMPUTADOR SERA RENOMEADO PARA: `n$new_name`nDESEJA CONFIRMAR E REINICIAR?", "CONFIRMACAO", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
					if ($resposta2 -eq [System.Windows.Forms.DialogResult]::Yes) {
						...
						$scriptPath = "C:\Windows\System32\adufrn.ps1"
